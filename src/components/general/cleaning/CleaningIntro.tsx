...
export default function CleaningIntro() {
  return (
    <div className='bg-primary md:mt-10 md:rounded-3xl rounded-xl  mb-10'>
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='bg-[url(/images/greenperson1.png)] bg-no-repeat bg-cover bg-center h-[40vh] md:rounded-3xl rounded-xl  md:h-full'></div>
            <div className='p-8 flex flex-col gap-4 justify-center items-start md:p-20'>
                ...
                <Link href={'/cleaning'}><Button className='border border-white text-white hover:bg-green-800 hover:cursor-pointer'>Get Started <ArrowRightIcon/></Button></Link>
            </div>
        </div>   
    </div>
  )
