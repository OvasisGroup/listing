    ...
    return (
        <div>
            ...
            <div className='border-t-1 border-gray-300 p-4 mt-4'>
                ...
                <div className='grid md:grid-cols-3 gap-12 my-20 justify-start items-start'>
                    <div className='flex flex-col items-center'>
                        <div className='bg-green-100 p-4 rounded-2xl'><Image src={'/images/project.svg'} alt={'Mr_Kim_Logo'} width={80} height={80} className='' /></div>
                        <h1 className='font-bold text-primary text-2xl pb-2 mt-4'>Telling US About Your Project</h1>
                    ...
                    <div className='flex flex-col items-center'>
                        <div className='bg-green-100 p-4 rounded-2xl'><Image src={'/images/technician.svg'} alt={'Mr_Kim_Logo'} width={80} height={80} className='' /></div>
                        <h1 className='font-bold text-primary text-2xl pb-2 mt-4'>Getting Matched</h1>
                        <p className='text-center'>Getting Matched with a Professional Service Provider in Your Area</p>
                    </div>
                    <div className='flex flex-col items-center'>
                        <div className='bg-green-100 p-4 rounded-2xl'><Image src={'/images/techtu.svg'} alt={'Mr_Kim_Logo'} width={80} height={80} className='' /></div>
                        <h1 className='font-bold text-primary text-2xl pb-2 mt-4'>Getting Connected</h1>
